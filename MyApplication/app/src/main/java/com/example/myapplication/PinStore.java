...
/**
 * Encrypted storage for vault PIN and recovery data.
 * Auto-migrates from plain SharedPreferences on first access.
 */
public final class PinStore {
    private PinStore() {}

    private static final String ENCRYPTED_NAME = "vault_pin_secure";
    private static final String PLAIN_NAME = "vault_pin_prefs";
    ...
    public static SharedPreferences get(Context context) {
        ...
        try {
            ...
            throw new IllegalStateException("Unable to open encrypted PIN store", e);
        }
    }
}
